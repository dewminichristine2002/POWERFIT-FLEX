...
<body>
        ...
        <form action="lw py process.php" method="post"  onsubmit="return validateFormsu();">
            ...
            <div class="card-type">
                ...
                <label for="visa"><img src="img/master.png" width="20%" height="62px" alt="Visa"></label>
                <input type="radio" name="card-type" value="mastercard" id="mastercard">
                <label for="mastercard"><img src="img/visa.png" width="20%" height="47px" alt="Mastercard"></label>
            </div>
            ...
            <div class="subuttons">
                <a href="\POWERFIT FLEX\Loose Weight page\Contact Trainer\trainer.php" class="subu">Back</a>

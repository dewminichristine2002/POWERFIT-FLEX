...
<html>
    <head>
    <link href="\POWERFIT FLEX\Loose Weight page\lw plan style.css" rel="stylesheet">
    </head>
<header>
...
echo "<p>This is your Loose Weight Exercise List.</p><br><br>";
    ...
    if ($lwexercise->num_rows>0) {
        ...
        while ($row = $lwexercise->fetch_assoc()) {
            ...
            echo '<td><img src="data:image/gif;base64,' . base64_encode($image) . '" alt="Image" width="200px" length="200px"></td>';
